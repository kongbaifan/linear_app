...
const en = {
  ...
  'settings.corsFail': 'The request never reached the server — likely CORS or network. The relay must allow browser cross-origin calls.',
...
const zh: Record<MessageKey, string> = {
  ...
  'settings.corsFail': '请求没有到达服务器——多半是 CORS 或网络问题。中转站需要允许浏览器跨域调用。',

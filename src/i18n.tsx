...
const en = {
  ...
  'chat.copy': 'Copy',
  'chat.copied': 'Copied',
  'diff.expand': 'Expand unchanged lines',
  'inbox.markRead': 'Mark read',
  'palette.goPulse': 'Go to Pulse',
  'pulse.range': 'Last 7 days',
  'pulse.created': 'Issues created',
  'pulse.runs': 'Agent runs',
  'pulse.chatMsgs': 'Chat messages',
  'pulse.revisions': 'Revision rounds',
  'pulse.prs': 'Pull requests',
  'pulse.doneIssues': 'Issues done',
  'pulse.review': 'Waiting for your review',
  'pulse.reviewEmpty': 'Nothing waiting for review.',
  'pulse.recent': 'Recently completed',
  'pulse.recentEmpty': 'No completed tasks yet.',
...
const zh: Record<MessageKey, string> = {
  ...
  'diff.expand': '展开未变更部分',
  'inbox.markRead': '标为已读',
  'palette.goPulse': '前往动态',
  'pulse.range': '最近 7 天',
  'pulse.created': '新建事项',
  'pulse.runs': 'Agent 任务',
  'pulse.chatMsgs': '对话消息',
  'pulse.revisions': '修订轮次',
  'pulse.prs': 'Pull Request',
  'pulse.doneIssues': '已完成事项',
  'pulse.review': '待你审查',
  'pulse.reviewEmpty': '没有等待审查的任务。',
  'pulse.recent': '最近完成',
  'pulse.recentEmpty': '还没有完成的任务。',
  'tpl.header': '委派方式…',
  'tpl.default': '默认方式',
